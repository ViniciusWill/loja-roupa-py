...
def Lançarcomprasnoestoque(Linhacaixa, estoque, CompTotal, NCompra, NEstoque, valorpag):
    novoprod = []
    contasapagar = []
    ...
    if condicao.any():
         ...
         estoque = pd.concat([estoque, NCompra], ignore_index=True)
         novoprod.append(NEstoque)
