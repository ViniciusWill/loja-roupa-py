...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (!campoBusca || !filtroStatus || !document.getElementById("tabelaEstoque")) {
        return;
    }

    campoBusca.addEventListener("input", filtrarTabelaEstoque);
    filtroStatus.addEventListener("change", filtrarTabelaEstoque);
});
