function filtrarTabelaContasPagar() {
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    campoBusca.addEventListener("input", filtrarTabelaContasPagar);
    filtroStatus.addEventListener("change", filtrarTabelaContasPagar);
});
